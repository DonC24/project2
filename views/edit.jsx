    ...
    return (
        ...
        <Layout>
            ...
            <form method="POST" action={url}>
                ...
                <p>Duration between each dose: {this.props.med.time_interval} hours<br />
